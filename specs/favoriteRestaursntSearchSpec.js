...
import FavoriteRestaurantSearchPresenter
  from '../src/scripts/views/pages/liked-restaurants/search-favorite-restaurant';
import FavoriteRestaurantIdb from '../src/scripts/data/favorite-idb';
import FavoriteRestaurantSearchView
  from '../src/scripts/views/pages/liked-restaurants/view-search-faovorite-restaurant';
